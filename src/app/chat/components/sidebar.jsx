...
export default function Sidebar_test() {
  return (
    <div
      className={`sidebar w-64 h-full bg-[#F4F4FF] p-8 flex justify-between flex-col ${montserrat.className}`}
    >
      <ul className="flex flex-col gap-8">
        {/* Add All Texts inside Spans */}
        <li>
      ...
      <div className="footer-profil w-full pb-40 max-w-[100%] mx-auto relative">
        ...
        <Image
          ...
          width={50}
          height={50}
          className="profil-img mx-auto pt-9 left-5 absolute left-[-7px]"
        />
        ...
        <Image
          ...
          width={20}
          height={20}
          className="logout-icon mx-auto pt-10 absolute right-[12px] top-2 cursor-pointer"
        />
      </div>
    </div>
  );
